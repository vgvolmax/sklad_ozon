...
function Assert-WebApplication {
    ...
    foreach ($asset in @("/assets/css/app.css", "/assets/js/core.js", "/assets/js/components.js", "/assets/js/flow_timeline.js", "/assets/js/flow.js", "/assets/js/app.js")) {
